...
| 改 | `docs/todo/2-web-search.md`、`6-p1b-unattended.md` | 重排序号为 1、2 |
...
2. 把 `2-web-search.md` 重命名为 `1-web-search.md`、
   `6-p1b-unattended.md` 重命名为 `6-p1b-unattended.md`。
3. 改两份文档内部的序号标题，**以及正文与开工 Prompt 段里的自引用**——
   陈旧引用不只在标题：`2-web-search.md` 与 `6-p1b-unattended.md` 的正文里
...
**验证：** `ls docs/todo/` 只剩 `README.md`、`1-web-search.md`、`6-p1b-unattended.md`；
