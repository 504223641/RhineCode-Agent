...
- **别用自己写的 fixture 验自己的 spec。** 提示词应当取自**真实使用中说过的话**
  ...
  不是为了让测试通过而编的措辞。这条与 `5-p1b-unattended.md` 里记的取样错误同源。
...
再读 docs/todo/3-skill-recall-eval.md 的完整背景与已知的坑。

做完这条后把 docs/todo/3-skill-recall-eval.md 删掉，并重排 docs/todo/ 下其余文档的序号。
```
