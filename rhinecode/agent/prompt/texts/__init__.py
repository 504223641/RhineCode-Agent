...
- 九个固定模块各一个文件（identity / system_constraints / **untrusted** / task_mode /
  delivery / action_execution / tool_usage / tone / text_output）；其中 untrusted 按开关注入；
...
from rhinecode.agent.prompt.texts.delivery import DELIVERY
