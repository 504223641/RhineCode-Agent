...
class SandboxWhitelistTest(unittest.TestCase):
    ...
    def test_workspace_semantics_unchanged(self) -> None:
        ...
        self.assertFalse(is_within_workspace(str(self.note)))
        self.assertTrue(is_within_workspace("rhinecode/config.py"))

    def test_clear_read_roots_restores(self) -> None:
        clear_read_roots()
        self.assertFalse(is_readable_path(str(self.note)))
