...
class AdapterTests(unittest.TestCase):
    def test_run_command_maps_to_bash_command(self) -> None:
        req = to_request(RunCommandTool(), {"command": "git status"}, PermissionMode.DEFAULT)
    ...
    def test_read_file_maps_to_read_path(self) -> None:
        req = to_request(ReadFileTool(), {"path": "src/a.py"}, PermissionMode.DEFAULT)
